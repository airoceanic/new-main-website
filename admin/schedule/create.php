...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $res = Api::sendSync('POST', 'v1/operations/schedule/flight', $data);
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <?php if ($status == "updated") { ?>
                    <div class="alert alert-success alert-dismissible fade show">Route successfully created. <a
                            href="<?php echo website_base_url; ?>flight_info.php?id=<?php echo $id; ?>">Click
                            here</a> to view the flight info.
                        <button class="btn-close" type="button" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                <?php } ?>
                <?php if ($status == "error") { ?>
                    <div class="alert alert-danger alert-dismissible fade show">An error has occurred creating the
                        flight.<br />
                        <ul>
