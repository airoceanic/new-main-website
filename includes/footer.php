...
<div class="cookie-banner text-center" style="display: none">
    <p>
        ...
        <button id="cookieAccept" class="btn btn-cta-primary">Ok</button>
    </p>
</div>
<?php } ?>
        ...
        <div class="row">
            ...
            <div class="col-md-4 text-center">
                <small class="copyright">
                    Copyright &copy; <?php echo date("Y"); ?> Air Oceanic
                </small>
                <br />
                <small>
                    <a href="<?php echo website_base_url; ?>privacy.php">Privacy Policy</a>
                    |
                    <a href="<?php echo website_base_url; ?>staff.php">Contact Us</a>
                </small>
            </div>
            ...
            <div class="col-md-4 text-right">
                ...
                <a href="<?php echo facebook_footer_link?>"
                    class="social-icons" target="_blank">
                ...
                <a href="<?php echo discord_footer_link?>"
                    class="social-icons" target="_blank">
                    <i class="fa fa-brands fa-discord" aria-hidden="true"></i>
                </a>
                <?php } ?>
