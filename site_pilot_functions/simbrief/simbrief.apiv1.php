...
$simbrief_api_key = simbrief_api_key; //Paste your API key here
...
class SimBrief
{
    ...
    */
    ...
    public $ofp_avail = false;
    public $ofp_obj = false;
    public $ofp_rawxml = false;
    public $ofp_json = false;
    public $ofp_array = false;
    ...
    */
    ...
    public function __construct($ofp_id)
    {
        $this->ofp_id = $ofp_id;
